...
#define ISRC_TIME_OUT         0x020000
#define ISRC_BAD_WC           0x040000
#define ISRC_MANCHESTER_ERROR 0x080000
#define ISRC_PARITY_ERROR     0x100000
#define ISRC_TR_BIT           0x200000
